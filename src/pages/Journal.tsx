...
const MW: Record<number, string[]> = {
  1: [
    ...
    '{p}g Dinde ({pc}g cuit) + {c}g Quinoa ({cc}g cuit) + Courgettes poêlées',
    '{p}g Cabillaud ({pc}g cuit) + {c}g Patates Douces ({cc}g cuit) + Asperges',
    '{p}g Crevettes ({pc}g cuit) + {c}g Riz ({cc}g cuit) + Poivrons + Ail',
    '{p}g Thon frais ({pc}g cuit) + {c}g Boulgour ({cc}g cuit) + Carottes râpées',
    '{p}g Boeuf Haché 5% ({pc}g cuit) + {c}g Lentilles ({cc}g cuit) + Épinards',
    '{p}g Maquereau ({pc}g cuit) + {c}g Riz ({cc}g cuit) + Chou-fleur rôti',
    '3 Oeufs + {p}g Dinde ({pc}g cuit) + {c}g Pain Complet + Salade verte',
    '{p}g Tofu ferme ({pc}g cuit) + {c}g Riz ({cc}g cuit) + Brocolis + Sauce soja',
    '{p}g Poulet ({pc}g cuit) + {c}g Patates Douces ({cc}g cuit) + Haricots Verts',
    '{p}g Saumon ({pc}g cuit) + {c}g Quinoa ({cc}g cuit) + Asperges + Citron',
    '{p}g Crevettes ({pc}g cuit) + {c}g Pâtes ({cc}g cuit) + Courgettes + Ail',
    '{p}g Dinde ({pc}g cuit) + {c}g Boulgour ({cc}g cuit) + Poivrons grillés',
  ],
  2: [
    ...
    '40g Whey + {ch}g Quinoa Cuit + 10 Amandes + Myrtilles',
    '40g Whey + 2 Tr. Pain Complet + 1/2 Avocat + Tomate',
    '40g Whey + {ch}g Patate Douce Cuite + 15g Beurre Cacahuète',
    '40g Whey + 50g Flocons Avoine + Cannelle + 1 Banane',
    '40g Whey + {ch}g Riz Cuit + 1 Oeuf Dur + Framboises',
    '40g Whey + 2 Galettes Riz + 15g Beurre Amande + Fruits',
    '40g Whey + {ch}g Boulgour Cuit + Noix + Miel 10g',
    '40g Whey + 2 Tr. Pain Complet + Cottage Cheese + Framboises',
    '40g Whey + {ch}g Pâtes Cuites + 1 Oeuf Brouillé + Épinards',
    '40g Whey + {ch}g Riz Cuit + Crevettes + Sauce Soja',
  ],
  3: [
    ...
    '{p3}g Cabillaud ({p3c}g cuit) + Ratatouille maison + Huile Olive',
    '{p3}g Dinde ({p3c}g cuit) + Chou-fleur gratiné léger',
    '{p3}g Thon en conserve + Grande Salade Composée + Huile Olive',
    '{p3}g Crevettes ({p3c}g cuit) + Wok Légumes (courgettes, poivrons, carottes)',
    '3 Oeufs en Omelette + {p3}g Jambon Blanc + Salade verte',
    '{p3}g Maquereau grillé ({p3c}g cuit) + Haricots Verts + Citron',
    '{p3}g Tofu ({p3c}g cuit) + Poêlée Asiatique (brocoli, carottes, soja)',
    '{p3}g Poulet ({p3c}g cuit) + Salade César légère (sans croûtons)',
    '{p3}g Saumon ({p3c}g cuit) + Asperges + Huile Olive + Citron',
    '{p3}g Boeuf Haché 5% ({p3c}g cuit) + Épinards sautés + Ail',
    '{p3}g Dinde ({p3c}g cuit) + Carottes Vichy + Persil',
    '{p3}g Cabillaud ({p3c}g cuit) + Poireaux vapeur + Huile Olive',
  ],
};
const MWE: Record<number, string[]> = {
  1: [
    'Grand Brunch : 3 Oeufs, 1/2 Avocat, Saumon fumé, Pain Complet',
    'Brunch Sucré-Salé : 2 Oeufs, Bacon dinde, Pancake protéiné, Fruits',
    'Omelette 4 Oeufs + Champignons + Fromage frais + Pain Complet',
    'Tartines : Pain Complet + Ricotta + Saumon fumé + Roquette',
    'Bowl Brunch : Skyr + Granola maison + Fruits + Beurre Cacahuète',
    'Croque-Monsieur Dinde + Salade verte + 1 Oeuf poché',
  ],
  2: [
    'Smoothie Whey, Fruits rouges, Amandes',
    'Smoothie Whey + Banane + Beurre Cacahuète + Lait Amande',
    'Bowl Açaí : 40g Whey + Fruits rouges + Granola + Coco râpée',
    'Smoothie Whey + Mangue + Épinards + Graines Chia',
    'Yaourt Grec 200g + Miel + Noix + 20g Whey',
    'Shake Whey + Avoine + Cannelle + 1 Banane',
  ],
  3: [
    'Repas Libre (Burger ou Pizza maison + Salade)',
    'Tacos Maison : Poulet grillé + Guacamole + Crudités',
    'Pâtes Bolognaise maison (boeuf 5%) + Salade verte',
    'Plancha : Crevettes + Légumes grillés + Riz',
    'Poulet rôti entier + Frites patate douce au four + Salade',
    'Sushi / Poke Bowl maison (saumon, riz, avocat, edamame)',
  ],
};
...
const TIPS = [
  ...
  '💧 Boire 500ml d\'eau avant chaque repas réduit l\'apport calorique de 13%.',
  '🥦 Les crucifères (brocoli, chou-fleur) favorisent la détox des œstrogènes.',
  '⏰ 16h de jeûne active l\'autophagie — le recyclage cellulaire.',
  '🏋️ La créatine (5g/j) augmente la force de 8% en 4 semaines.',
  '🐟 2 portions de poisson gras/semaine couvrent vos besoins en oméga-3.',
  '🧠 Le magnésium améliore la qualité du sommeil et réduit le cortisol.',
  '🍋 Le vinaigre de cidre (1 c.s. avant repas) réduit le pic glycémique.',
  '☀️ La vitamine D3 optimise la testostérone et l\'immunité.',
  '🥚 Le jaune d\'oeuf contient de la choline — essentielle pour le foie.',
  '🫐 Les fruits rouges sont les fruits les plus riches en antioxydants et les plus pauvres en sucre.',
  '🧂 Réduire le sel à 5g/j diminue la rétention d\'eau et la tension artérielle.',
  '🥑 L\'avocat fournit du potassium (plus que la banane) et des graisses mono-insaturées.',
  '🔥 Le NEAT (activité hors sport) représente 15-30% de votre dépense calorique totale.',
  '📏 Le tour de taille est un meilleur indicateur de santé que le poids sur la balance.',
  '🫧 Le stress chronique augmente le cortisol → stockage abdominal. Respirez.',
  '🥗 Manger des légumes en premier ralentit l\'absorption des glucides.',
];
