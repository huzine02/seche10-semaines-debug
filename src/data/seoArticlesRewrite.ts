...
export const seoArticlesRewrite: BlogArticle[] = [
  // �"��"��"� ARTICLE 11 �"��"��"�
  {
    ...
    title: "Comment Calculer Ses Macros pour Sécher : Guide �?tape par �?tape",
    ...
    content: `
<h1>Comment Calculer Ses Macros pour Sécher : Guide �?tape par �?tape</h1>
...
�Y'� <strong>Avis d'expert :</strong> <em>"La recommandation de 2,3-3,1 g/kg de masse maigre est le sweet spot. En dessous, vous risquez de perdre du muscle. Au-dessus, il n'y a pas de bénéfice supplémentaire mesurable."</em> �?" <strong>Eric Helms</strong>, chercheur et auteur de <em>The Muscle & Strength Pyramid</em>
</blockquote>

<div style="background:#fff3cd;border-left:4px solid #ffc107;padding:20px;margin:20px 0;border-radius:8px;">
<strong>�s�️ Règle absolue :</strong> En sèche, vos protéines ne descendent JAMAIS en dessous de 2 g/kg de poids de corps. Idéalement, visez 2,2 g/kg (soit ~2,6-3,0 g/kg de masse maigre pour un homme à 15-20% de MG).
</div>
...
<ul>
<li><strong>�?nergie à l'entraînement</strong> : le glycogène musculaire est le carburant principal des séances de musculation intense (>70% 1RM)</li>
...
<blockquote style="background:#f0fdf4;border-left:4px solid #22c55e;padding:16px 20px;margin:20px 0;border-radius:8px;">
�Y'� <strong>Avis d'expert :</strong> <em>"Les glucides sont la variable d'ajustement, pas l'ennemi. Coupez-les trop et vos performances en salle s'effondrent, ce qui accélère la perte musculaire."</em> �?" <strong>Dr. Mike Israetel</strong>, co-fondateur de Renaissance Periodization
</blockquote>

<h2>La méthode de calcul en 4 étapes</h2>

<h3>�?tape 1 : Déterminer vos calories cibles</h3>

<p><strong>Calories de sèche = TDEE �- 0,75 à 0,80</strong> (soit un déficit de 20-25%)</p>
...
<h3>�?tape 2 : Fixer les protéines</h3>
...
<blockquote style="background:#e8f4fd;border-left:4px solid #0ea5e9;padding:16px 20px;margin:20px 0;border-radius:8px;">
�Y"� <strong>Ce que dit la science :</strong> Helms et al. (2014, <em>Journal of the ISSN</em>) recommandent 2,3-3,1 g/kg de masse maigre pendant un déficit calorique chez les athlètes pratiquant la musculation. Les sujets les plus maigres nécessitent l'extrémité haute de la fourchette.
</blockquote>

<h3>�?tape 3 : Fixer les lipides</h3>
...
<strong>�Ys� Attention après 40 ans :</strong> Ne descendez jamais vos lipides en dessous de 0,8 g/kg. La production de testostérone décline naturellement de ~1% par an après 30 ans (Travison et al., 2007, <em>JCEM</em>). Un régime trop pauvre en graisses accélérera ce déclin.
</div>

<h3>�?tape 4 : Calculer les glucides (ce qui reste)</h3>
...
<li>Protéines : 92 �- 2,0 = <strong>184 g</strong> (736 kcal) �?" coefficient à 2,0 car >25% MG estimé</li>
...
<li>Protéines : 75 �- 2,4 = <strong>180 g</strong> (720 kcal) �?" coefficient à 2,4 car <20% MG</li>
...
<blockquote style="background:#f0fdf4;border-left:4px solid #22c55e;padding:16px 20px;margin:20px 0;border-radius:8px;">
�Y'� <strong>Avis d'expert :</strong> <em>"Le carb cycling n'est pas magique pour la perte de graisse �?" le total calorique hebdomadaire reste roi. Mais il optimise les performances à l'entraînement et l'adhérence psychologique."</em> �?" <strong>Alan Aragon</strong>, chercheur en nutrition sportive
</blockquote>
...
<h4 style="margin-top:0;">�Y'� Règle simple pour le carb cycling</h4>
...
<li><strong>Viser la perfection quotidienne</strong> �?' C'est la moyenne hebdomadaire qui compte. Le corps ne remet pas les compteurs à zéro à minuit</li>
</ol>

<div style="background:#f3e5f5;border-left:4px solid #9c27b0;padding:20px;margin:20px 0;border-radius:8px;">
<h4 style="margin-top:0;">�Y"� Votre calcul en 4 lignes</h4>
<ol>
...
<h3 style="margin-top:0;">�Y"S Macros calculées automatiquement, menus inclus</h3>
...
<p>C'est LA règle la plus importante. Si vous développé couché à 90 kg en prise de masse, votre objectif en sèche est de rester à 90 kg �?" ou le plus proche possible.</p>
...
<blockquote style="background:#f0fdf4;border-left:4px solid #22c55e;padding:16px 20px;margin:20px 0;border-radius:8px;">
�Y'� <strong>Avis d'expert :</strong> <em>"L'intensité relative (% du 1RM) est le facteur le plus important pour préserver la masse musculaire en déficit. Vous pouvez couper le volume de moitié, mais ne coupez jamais l'intensité."</em> �?" <strong>Eric Helms</strong>, <em>The Muscle & Strength Pyramid</em>
</blockquote>

<div style="background:#fff3cd;border-left:4px solid #ffc107;padding:20px;margin:20px 0;border-radius:8px;">
<strong>�s�️ Réalité en sèche :</strong> une légère baisse de force (5-10%) est normale après 4-6 semaines de déficit. Au-delà de 15%, votre déficit est trop agressif ou votre récupération insuffisante.
</div>
...
<blockquote style="background:#e8f4fd;border-left:4px solid #0ea5e9;padding:16px 20px;margin:20px 0;border-radius:8px;">
�Y"� <strong>Ce que dit la science :</strong> Une revue systématique de Schoenfeld et al. (2017, <em>Journal of Sports Sciences</em>) indique qu'un minimum de 10 séries par groupe musculaire par semaine est optimal pour la croissance en surplus. En sèche, Israetel recommande de réduire à 60-75% de ce volume �?" soit <strong>6-12 séries par groupe musculaire par semaine</strong> �?" tout en maintenant les charges.
</blockquote>

<ul>
<li>Si vous faisiez 5 séries de développé couché �?' passez à 3-4</li>
<li>Si vous faisiez 20 séries/semaine par groupe �?' passez à 12-15</li>
...
<blockquote style="background:#f0fdf4;border-left:4px solid #22c55e;padding:16px 20px;margin:20px 0;border-radius:8px;">
�Y'� <strong>Avis d'expert :</strong> <em>"Le repos court entre les séries est un mauvais outil de dépense calorique. Pour brûler des calories, marchez 30 min après votre séance. En salle, reposez-vous assez pour maintenir vos charges."</em> �?" <strong>Dr. Mike Israetel</strong>, Renaissance Periodization
</blockquote>

<h3>Principe 5 : �?chauffement renforcé</h3>
...
<p>Ce split en 4 jours stimule chaque groupe musculaire 1,5 à 2 fois par semaine �?" la fréquence optimale en déficit.</p>

<h3>Jour 1 �?" Push (Poitrine, �?paules, Triceps)</h3>
...
<tr><td>Développé militaire barre</td><td>3 �- 8-10</td><td>2 min</td><td>Debout ou assis</td></tr>
<tr><td>�?lévations latérales</td><td>3 �- 12-15</td><td>60 sec</td><td>Contrôlez la descente</td></tr>
...
<tr><td>Presse à cuisses</td><td>3 �- 10-12</td><td>2 min</td><td>Pieds hauts = plus de fessiers</td></tr>
...
<tr><td>�?paules</td><td>9</td><td>2�-/sem</td></tr>
...
<div style="background:#f0f7ff;border-left:4px solid #2563eb;padding:20px;margin:30px 0;border-radius:8px;">
<h3 style="margin-top:0;">�Y�<️ Programme clé en main avec vidéos</h3>
...
<blockquote style="background:#e8f4fd;border-left:4px solid #0ea5e9;padding:16px 20px;margin:20px 0;border-radius:8px;">
�Y"� <strong>Ce que dit la science :</strong> Müller & Bosy-Westphal (2013, <em>Obesity Reviews</em>) ont identifié que l'adaptation métabolique �?" la réduction du métabolisme au-delà de ce que prédit la perte de poids �?" peut atteindre 80-120 kcal/jour après 8-12 semaines de déficit. C'est réel, mais souvent surestimé par les gens en plateau.
</blockquote>
...
<ul>
<li><strong>La balance seule ment.</strong> Rétention d'eau, cycle hormonal, volume alimentaire dans l'intestin �?' le poids peut fluctuer de 0,5 à 2 kg d'un jour à l'autre</li>
...
<blockquote style="background:#f0fdf4;border-left:4px solid #22c55e;padding:16px 20px;margin:20px 0;border-radius:8px;">
�Y'� <strong>Avis d'expert :</strong> <em>"Le 'whoosh effect' est réel. Le corps remplace temporairement la graisse perdue par de l'eau dans les adipocytes. Puis un matin, vous urinez beaucoup et perdez 1 kg d'un coup. Patience."</em> �?" <strong>Lyle McDonald</strong>, auteur de <em>The Stubborn Fat Solution</em>
</blockquote>
...
<blockquote style="background:#f0fdf4;border-left:4px solid #22c55e;padding:16px 20px;margin:20px 0;border-radius:8px;">
�Y'� <strong>Avis d'expert :</strong> <em>"Le diet break n'est pas de la faiblesse. C'est une stratégie de conservation métabolique. Après 6-8 semaines de déficit, une semaine à maintenance fait plus de bien que de mal."</em> �?" <strong>Dr. Layne Norton</strong>, PhD en sciences nutritionnelles
</blockquote>
...
<p><strong>Protocole :</strong> Recalculez votre TDEE avec votre poids actuel. Réduisez de 100-150 kcal (principalement sur les glucides). Ne descendez jamais en dessous de MB �- 1,2.</p>

<h2>Solution 5 : Améliorez votre sommeil</h2>

<blockquote style="background:#e8f4fd;border-left:4px solid #0ea5e9;padding:16px 20px;margin:20px 0;border-radius:8px;">
�Y"� <strong>Ce que dit la science :</strong> Nedeltcheva et al. (2010, <em>Annals of Internal Medicine</em>) ont comparé 8,5h vs 5,5h de sommeil pendant un déficit calorique. Les deux groupes ont perdu le même poids total, mais le groupe privé de sommeil a perdu <strong>60% plus de masse maigre</strong> et 55% moins de graisse. Le ratio muscle/graisse perdu était catastrophique avec un sommeil insuffisant.
</blockquote>
...
<blockquote style="background:#f0fdf4;border-left:4px solid #22c55e;padding:16px 20px;margin:20px 0;border-radius:8px;">
�Y'� <strong>Avis d'expert :</strong> <em>"J'ai vu des clients débloquer un plateau de 3 semaines simplement en réduisant leur stress et en dormant mieux. Pas de changement alimentaire. Le cortisol peut causer 1-2 kg de rétention d'eau qui masque la perte de graisse."</em> �?" <strong>Menno Henselmans</strong>, chercheur en sciences du sport
</blockquote>
...
<p><strong>Protocole :</strong> Ajoutez 2-3 séances de 30-40 min de marche rapide (6-7 km/h). Dépense supplémentaire : ~150-200 kcal/séance. �?quivalent à une réduction calorique de 100 kcal/jour sur la semaine.</p>
...
<div style="background:#f0f7ff;border-left:4px solid #2563eb;padding:20px;margin:30px 0;border-radius:8px;">
<h3 style="margin-top:0;">�Y"? Plateau intégré dans le programme</h3>
...
<p>Peser chaque aliment, scanner chaque code-barre, calculer chaque macro... c'est efficace mais <strong>insoutenable pour la majorité des hommes</strong>. La bonne nouvelle ? Vous pouvez sécher sans jamais ouvrir MyFitnessPal �?" à condition de suivre des règles structurelles précises.</p>

<blockquote style="background:#e8f4fd;border-left:4px solid #0ea5e9;padding:16px 20px;margin:20px 0;border-radius:8px;">
�Y"� <strong>Ce que dit la science :</strong> Gardner et al. (2018, étude DIETFITS, <em>JAMA</em>, n=609) ont montré qu'après 12 mois, les groupes qui suivaient des "règles alimentaires simples" (qualité des aliments, portions visuelles) perdaient autant de poids que ceux qui comptaient les calories �?" avec un taux d'adhérence supérieur de 23%.
</blockquote>
...
<blockquote style="background:#f0fdf4;border-left:4px solid #22c55e;padding:16px 20px;margin:20px 0;border-radius:8px;">
�Y'� <strong>Avis d'expert :</strong> <em>"La meilleure diète est celle que vous pouvez suivre. Pour 80% des gens, compter les calories est un outil temporaire d'éducation, pas une stratégie à vie. Les règles structurelles sont plus durables."</em> �?" <strong>Alan Aragon</strong>, chercheur en nutrition sportive
</blockquote>
...
<ul>
<li><strong>1/3 de l'assiette = protéines</strong> : une portion de la taille de votre paume (poulet, poisson, �"ufs, viande maigre, tofu)</li>
<li><strong>1/3 de l'assiette = légumes</strong> : à volonté ou presque �?" brocoli, courgettes, haricots verts, épinards, salade</li>
...
<blockquote style="background:#e8f4fd;border-left:4px solid #0ea5e9;padding:16px 20px;margin:20px 0;border-radius:8px;">
�Y"� <strong>Ce que dit la science :</strong> Rolls (2009, <em>Physiology & Behavior</em>) a démontré que la densité énergétique des aliments (kcal/g) est le prédicteur n°1 de la quantité totale de calories consommées. Les légumes (0,1-0,5 kcal/g) et les protéines maigres (1,0-1,5 kcal/g) induisent la satiété avec beaucoup moins de calories que les aliments transformés (3-5 kcal/g).
</blockquote>

<h2>Règle 2 : Protéines à chaque repas �?" non négociable</h2>
...
<ul>
<li>Petit-déjeuner : 3-4 �"ufs ou yaourt grec + whey</li>
...
<blockquote style="background:#f0fdf4;border-left:4px solid #22c55e;padding:16px 20px;margin:20px 0;border-radius:8px;">
�Y'� <strong>Avis d'expert :</strong> <em>"La distribution des protéines sur 3-4 repas est optimale pour la synthèse protéique musculaire. Visez 0,4-0,55 g/kg par repas, soit environ 30-45 g de protéines par repas pour un homme de 80 kg."</em> �?" <strong>Stuart Phillips</strong>, professeur à l'Université McMaster, expert mondial en métabolisme protéique
</blockquote>

<h2>Règle 3 : �?liminez les calories liquides</h2>
...
<blockquote style="background:#e8f4fd;border-left:4px solid #0ea5e9;padding:16px 20px;margin:20px 0;border-radius:8px;">
�Y"� <strong>Ce que dit la science :</strong> Shukla et al. (2017, <em>BMJ Open Diabetes Research & Care</em>) ont montré que manger les protéines et légumes AVANT les glucides réduisait le pic de glycémie post-prandial de 73% et l'insuline de 48%. Bonus indirect : moins de fringales dans les heures suivantes.
</blockquote>
...
<p><strong>Astuce pratique :</strong> posez vos couverts entre chaque bouchée. Mâchez 15-20 fois. �?a paraît ridicule �?" ça marche.</p>
...
<div style="background:#f0f7ff;border-left:4px solid #2563eb;padding:20px;margin:30px 0;border-radius:8px;">
<h3 style="margin-top:0;">�Y��️ Menus structurés, zéro calcul</h3>
...
<p>La testostérone totale diminue de ~1-2% par an après 30 ans. �? 50 ans, vous avez potentiellement 20-30% de moins qu'à 25 ans. Mais la musculation et la nutrition peuvent partiellement compenser.</p>

<blockquote style="background:#e8f4fd;border-left:4px solid #0ea5e9;padding:16px 20px;margin:20px 0;border-radius:8px;">
�Y"� <strong>Ce que dit la science :</strong> Travison et al. (2007, <em>Journal of Clinical Endocrinology & Metabolism</em>) ont suivi 1 667 hommes de 40 à 70 ans pendant 15 ans. La testostérone totale déclinait de 1,6%/an et la testostérone libre de 2-3%/an. Cependant, Hayes & Elliott (2019) ont montré que l'entraînement en résistance augmente la testostérone de 15-20% dans les heures suivant la séance �?" un effet chronique bénéfique.
</blockquote>
...
<blockquote style="background:#f0fdf4;border-left:4px solid #22c55e;padding:16px 20px;margin:20px 0;border-radius:8px;">
�Y'� <strong>Avis d'expert :</strong> <em>"Après 40 ans, la résistance anabolique augmente. Le muscle devient moins sensible au stimulus protéique. Il faut donc plus de leucine par repas �?" au moins 3-4 g, soit 35-40 g de protéines de haute qualité par prise."</em> �?" <strong>Stuart Phillips</strong>, Université McMaster
</blockquote>
...
<li><strong>�?chauffement prolongé</strong> : 15-20 min minimum. Vos articulations en ont besoin</li>
...
<tr><td>Squat goblet ou barre</td><td>3 �- 8-10</td><td>2-3 min</td></tr>
<tr><td>Développé couché haltères</td><td>3 �- 8-10</td><td>2 min</td></tr>
<tr><td>Rowing haltère unilatéral</td><td>3 �- 10-12</td><td>90 sec</td></tr>
<tr><td>Développé épaules haltères</td><td>3 �- 10-12</td><td>90 sec</td></tr>
<tr><td>Planche</td><td>3 �- 30-45 sec</td><td>60 sec</td></tr>
</table>

<h4>Jour B (mercredi)</h4>
<table>
<tr><th>Exercice</th><th>Séries �- Reps</th><th>Repos</th></tr>
<tr><td>Soulevé de terre roumain</td><td>3 �- 8-10</td><td>2-3 min</td></tr>
<tr><td>Tractions ou tirage vertical</td><td>3 �- 8-10</td><td>2 min</td></tr>
<tr><td>Développé incliné haltères</td><td>3 �- 10-12</td><td>90 sec</td></tr>
<tr><td>Fentes haltères</td><td>3 �- 10/jambe</td><td>90 sec</td></tr>
<tr><td>Pallof press</td><td>3 �- 12/côté</td><td>60 sec</td></tr>
</table>

<h4>Jour C (vendredi)</h4>
<table>
<tr><th>Exercice</th><th>Séries �- Reps</th><th>Repos</th></tr>
<tr><td>Presse à cuisses</td><td>3 �- 10-12</td><td>2 min</td></tr>
<tr><td>Développé couché barre</td><td>3 �- 6-8</td><td>2-3 min</td></tr>
<tr><td>Rowing barre</td><td>3 �- 8-10</td><td>2 min</td></tr>
<tr><td>Face pulls</td><td>3 �- 15</td><td>60 sec</td></tr>
<tr><td>Relevé de jambes suspendu</td><td>3 �- 10-12</td><td>60 sec</td></tr>
</table>

<h2>La nutrition après 45 ans en sèche</h2>

<ul>
<li><strong>Protéines</strong> : 2,0-2,2 g/kg �?" plus élevé que les jeunes à cause de la résistance anabolique</li>
...
<blockquote style="background:#e8f4fd;border-left:4px solid #0ea5e9;padding:16px 20px;margin:20px 0;border-radius:8px;">
�Y"� <strong>Ce que dit la science :</strong> Wall et al. (2015, <em>Journal of Nutrition</em>) ont montré que les adultes de 65+ ans nécessitaient ~0,40 g/kg de protéines par repas pour maximiser la synthèse protéique musculaire, contre ~0,25 g/kg chez les jeunes. Ce seuil plus élevé est lié à la résistance anabolique liée à l'âge.
</blockquote>
...
<blockquote style="background:#f0fdf4;border-left:4px solid #22c55e;padding:16px 20px;margin:20px 0;border-radius:8px;">
�Y'� <strong>Avis d'expert :</strong> <em>"La distribution protéique optimale est de 0,4-0,55 g/kg répartis sur 3-5 prises. Chaque prise doit contenir au minimum 20 g de protéines �?" et idéalement 2,5+ g de leucine �?" pour stimuler efficacement la synthèse protéique musculaire."</em> �?" <strong>Stuart Phillips</strong>, Université McMaster
</blockquote>
...
<blockquote style="background:#e8f4fd;border-left:4px solid #0ea5e9;padding:16px 20px;margin:20px 0;border-radius:8px;">
�Y"� <strong>Ce que dit la science :</strong> Res et al. (2012, <em>Medicine & Science in Sports & Exercise</em>) ont montré que 40 g de caséine avant le coucher augmentaient la synthèse protéique musculaire de 22% pendant la nuit chez des hommes s'entraînant en résistance, comparé à un placebo.
</blockquote>

<h3>3. �'ufs durs (2-3 pièces) (150-220 kcal)</h3>
...
<p>2 galettes de riz + 10 g de beurre de cacahuète + filet de miel. <strong>5 g de protéines, 30 g de glucides, 7 g de lipides.</strong> �?nergie rapide sans lourdeur.</p>
...
<blockquote style="background:#f0fdf4;border-left:4px solid #22c55e;padding:16px 20px;margin:20px 0;border-radius:8px;">
�Y'� <strong>Avis d'expert :</strong> <em>"Pour la performance, l'apport pré-entraînement idéal est de 0,4 g/kg de protéines + 0,4-0,8 g/kg de glucides, 1-3 heures avant la séance. L'urgence du timing diminue si vous avez mangé un vrai repas dans les 3-4h précédentes."</em> �?" <strong>Alan Aragon</strong>
</blockquote>
...
<p>Le HIIT (High-Intensity Interval Training) est l'outil cardio le plus efficace en termes de <strong>temps investi vs graisse brûlée</strong>. En 20 minutes, vous créez un déficit calorique comparable à 40-50 minutes de cardio classique �?" avec un bonus métabolique qui dure des heures.</p>
...
<blockquote style="background:#e8f4fd;border-left:4px solid #0ea5e9;padding:16px 20px;margin:20px 0;border-radius:8px;">
�Y"� <strong>Ce que dit la science :</strong> Knab et al. (2011, <em>Medicine & Science in Sports & Exercise</em>) ont mesuré que 45 minutes d'exercice intense augmentaient le métabolisme de 190 kcal sur les 14 heures suivantes. Pour une séance HIIT de 20 minutes, l'EPOC est estimé à 50-80 kcal supplémentaires �?" modeste mais réel.
</blockquote>

<blockquote style="background:#f0fdf4;border-left:4px solid #22c55e;padding:16px 20px;margin:20px 0;border-radius:8px;">
�Y'� <strong>Avis d'expert :</strong> <em>"L'EPOC est réel mais souvent surestimé dans le marketing fitness. Le vrai avantage du HIIT, c'est l'efficacité temporelle et l'impact sur la graisse viscérale, pas les '500 kcal brûlées après l'entraînement' qu'on vous vend."</em> �?" <strong>Menno Henselmans</strong>
</blockquote>
...
<p>Structure : 8 rounds de (20 sec effort maximal / 10 sec repos) �- 2 blocs, avec 2 min de récupération entre les blocs.</p>
...
<blockquote style="background:#e8f4fd;border-left:4px solid #0ea5e9;padding:16px 20px;margin:20px 0;border-radius:8px;">
�Y"� <strong>Ce que dit la science :</strong> Tabata et al. (1996, <em>Medicine & Science in Sports & Exercise</em>) ont montré que 4 minutes de HIIT 20/10 amélioraient à la fois la VO2max (+14%) et la capacité anaérobie (+28%) en 6 semaines, alors que 60 minutes de cardio modéré n'amélioraient que la VO2max.
</blockquote>
...
<p>�?chauffement : 3 min à intensité légère</p>
<ul>
<li>8 �- (30 sec sprint maximal / 90 sec récupération active)</li>
</ul>
...
<p>�?chauffement : 3 min à 20 coups/min</p>
<ul>
<li>6 �- (1 min effort intense à 28-32 coups/min / 1 min récupération à 18-20 coups/min)</li>
</ul>
...
<div style="background:#fff3cd;border-left:4px solid #ffc107;padding:20px;margin:20px 0;border-radius:8px;">
<strong>�s�️ Règles d'intégration :</strong>
...
<li>Si même jour : HIIT APR�^S la musculation, jamais avant</li>
...
<blockquote style="background:#e8f4fd;border-left:4px solid #0ea5e9;padding:16px 20px;margin:20px 0;border-radius:8px;">
�Y"� <strong>Ce que dit la science :</strong> Wilson et al. (2012, <em>Journal of Strength & Conditioning Research</em>) ont montré que le cardio concurrent (HIIT + musculation le même jour) réduit les gains de force et d'hypertrophie de 15-20% si les séances ne sont pas séparées d'au moins 6 heures. Placez vos séances HIIT sur des jours séparés quand possible.
</blockquote>

<div style="background:#f0f7ff;border-left:4px solid #2563eb;padding:20px;margin:30px 0;border-radius:8px;">
<h3 style="margin-top:0;">�Y"� HIIT intégré au programme</h3>
...
`
  ...
  // �"��"��"� ARTICLE 18 �"��"��"�
  {
    ...
    title: "Les 12 Erreurs de Sèche en Musculation (et Comment les �?viter)",
    metaDescription: "Les 12 erreurs les plus courantes en sèche musculation. �?vitez-les pour perdre du gras efficacement et garder votre muscle.",
    content: `
<h1>Les 12 Erreurs de Sèche en Musculation (et Comment les �?viter)</h1>
...
<blockquote style="background:#f0fdf4;border-left:4px solid #22c55e;padding:16px 20px;margin:20px 0;border-radius:8px;">
�Y'� <strong>Avis d'expert :</strong> <em>"En déficit calorique, vos besoins en protéines augmentent, ils ne diminuent pas. Le corps utilise davantage les acides aminés comme substrat énergétique quand les calories sont basses. Si vous ne compensez pas, c'est le muscle qui trinque."</em> �?" <strong>Eric Helms</strong>
</blockquote>
...
<blockquote style="background:#f0fdf4;border-left:4px solid #22c55e;padding:16px 20px;margin:20px 0;border-radius:8px;">
�Y'� <strong>Avis d'expert :</strong> <em>"L'idée de 'séries de définition' est le pire conseil de la culture fitness. La définition musculaire est 100% une question de pourcentage de graisse corporelle. En sèche, gardez vos charges lourdes �?" c'est le signal de préservation musculaire."</em> �?" <strong>Dr. Mike Israetel</strong>
</blockquote>
...
<blockquote style="background:#e8f4fd;border-left:4px solid #0ea5e9;padding:16px 20px;margin:20px 0;border-radius:8px;">
�Y"� <strong>Ce que dit la science :</strong> Nedeltcheva et al. (2010, <em>Annals of Internal Medicine</em>) : 5,5h vs 8,5h de sommeil en déficit calorique. Le groupe en manque de sommeil a perdu 60% plus de masse maigre et 55% moins de graisse. Le ratio de perte était catastrophique : 80% muscle / 20% graisse vs 20% muscle / 80% graisse.
</blockquote>
...
<blockquote style="background:#f0fdf4;border-left:4px solid #22c55e;padding:16px 20px;margin:20px 0;border-radius:8px;">
�Y'� <strong>Avis d'expert :</strong> <em>"Il vaut mieux créer le déficit par l'alimentation que par le cardio. Le cardio est un outil d'ajustement fin, pas le moteur principal de votre sèche. Visez 80% alimentation / 20% cardio pour créer le déficit."</em> �?" <strong>Dr. Layne Norton</strong>
</blockquote>
...
<blockquote style="background:#e8f4fd;border-left:4px solid #0ea5e9;padding:16px 20px;margin:20px 0;border-radius:8px;">
�Y"� <strong>Ce que dit la science :</strong> Trexler et al. (2014, <em>Journal of the ISSN</em>) recommandent un reverse diet progressif après la sèche : augmentez les calories de 100-150 kcal/semaine (principalement glucides) jusqu'à atteindre votre nouveau TDEE. Cela minimise le regain de graisse tout en restaurant le métabolisme.
</blockquote>
...
<blockquote style="background:#f0fdf4;border-left:4px solid #22c55e;padding:16px 20px;margin:20px 0;border-radius:8px;">
�Y'� <strong>Avis d'expert :</strong> <em>"Vous n'avez pas besoin de motivation pour vous brosser les dents. L'objectif est que la sèche devienne pareil : un système automatisé, pas une épreuve de volonté quotidienne."</em> �?" <strong>Lyle McDonald</strong>
</blockquote>

<div style="background:#f0f7ff;border-left:4px solid #2563eb;padding:20px;margin:30px 0;border-radius:8px;">
<h3 style="margin-top:0;">�o. �?vitez toutes ces erreurs</h3>
...
<blockquote style="background:#e8f4fd;border-left:4px solid #0ea5e9;padding:16px 20px;margin:20px 0;border-radius:8px;">
�Y"� <strong>Ce que dit la science :</strong> Mero et al. (2010, <em>Journal of the ISSN</em>) ont étudié des athlètes en déficit agressif (-750 kcal/jour) pendant 4 semaines avec un apport protéique élevé (2,5 g/kg). Résultat : -3,1 kg de masse grasse avec une perte de masse maigre quasi nulle (-0,3 kg). La clé : protéines très élevées + musculation intense maintenue.
</blockquote>

<div style="background:#fce4ec;border-left:4px solid #e53935;padding:20px;margin:20px 0;border-radius:8px;">
<strong>�Ys� Prérequis :</strong> Ce programme accéléré n'est PAS pour les débutants complets ni les hommes en surpoids important (>30% MG). Il est conçu pour les hommes qui s'entraînent déjà depuis au moins 3 mois et qui veulent un "coup de boost" rapide.
</div>
...
<ul>
<li>Cible : 2 600 �- 0,72 = <strong>~1 870 kcal/jour</strong></li>
...
<blockquote style="background:#f0fdf4;border-left:4px solid #22c55e;padding:16px 20px;margin:20px 0;border-radius:8px;">
�Y'� <strong>Avis d'expert :</strong> <em>"Pour une perte de poids rapide en préservant le muscle, les protéines doivent être au maximum de la fourchette recommandée. Je mets mes clients à 2,5 g/kg minimum pour les déficits agressifs de courte durée."</em> �?" <strong>Menno Henselmans</strong>
</blockquote>
...
<ul>
<li><strong>Petit-déjeuner</strong> : 4 blancs d'�"uf + 1 �"uf entier + 40 g de flocons d'avoine + 100 g de myrtilles (350 kcal)</li>
...
<ul>
<li><strong>Petit-déjeuner</strong> : 3 �"ufs entiers + 150 g d'épinards sautés + 1 tranche de pain complet (350 kcal)</li>
...
<div style="background:#fff3cd;border-left:4px solid #ffc107;padding:20px;margin:20px 0;border-radius:8px;">
<strong>�s�️ Après les 4 semaines :</strong> Passez OBLIGATOIREMENT en reverse diet progressif (+100-150 kcal/semaine) ou en sèche classique à -20% de déficit. Ne prolongez pas le programme express au-delà de 4 semaines �?" le risque de perte musculaire et d'adaptation métabolique devient trop élevé.
</div>

<div style="background:#f0f7ff;border-left:4px solid #2563eb;padding:20px;margin:30px 0;border-radius:8px;">
<h3 style="margin-top:0;">�s� Programme express intégré</h3>
...
`
  ...
  // �"��"��"� ARTICLE 20 �"��"��"�
  {
    ...
    metaDescription: "�?liminer les poignées d'amour chez l'homme : nutrition, entraînement et stratégie pour perdre cette graisse abdominale tenace.",
    content: `
...
<blockquote style="background:#e8f4fd;border-left:4px solid #0ea5e9;padding:16px 20px;margin:20px 0;border-radius:8px;">
�Y"� <strong>Ce que dit la science :</strong> Vispute et al. (2011, <em>Journal of Strength & Conditioning Research</em>) ont soumis des sujets à 6 semaines d'exercices abdominaux quotidiens SANS déficit calorique. Résultat : zéro réduction de la graisse abdominale. Les abdominaux étaient plus forts, mais la graisse n'avait pas bougé. La perte de graisse localisée N'EXISTE PAS.
</blockquote>
...
<blockquote style="background:#f0fdf4;border-left:4px solid #22c55e;padding:16px 20px;margin:20px 0;border-radius:8px;">
�Y'� <strong>Avis d'expert :</strong> <em>"La graisse 'tenace' est réelle, pas un mythe. Les zones à forte densité de récepteurs alpha-2 (abdomen, bas du dos, hanches chez l'homme) sont les dernières à se vider. La seule solution : continuer le déficit calorique suffisamment longtemps. Il n'y a pas de raccourci."</em> �?" <strong>Lyle McDonald</strong>, auteur de <em>The Stubborn Fat Solution</em>
</blockquote>

<h3>Le rôle du cortisol</h3>

<p>Le cortisol �?" l'hormone du stress �?" a une affinité particulière pour le dépôt de graisse abdominale. Il active l'enzyme 11β-HSD1 dans le tissu adipeux viscéral, favorisant le stockage local.</p>

<blockquote style="background:#e8f4fd;border-left:4px solid #0ea5e9;padding:16px 20px;margin:20px 0;border-radius:8px;">
�Y"� <strong>Ce que dit la science :</strong> Epel et al. (2000, <em>Psychoneuroendocrinology</em>) ont montré que les femmes et hommes avec une réactivité élevée au cortisol stockaient significativement plus de graisse abdominale, indépendamment de leur IMC total. Le stress chronique = plus de graisse sur le ventre et les flancs.
</blockquote>
...
<ul>
<li><strong>Pallof press</strong> : 3 �- 12/côté �?" travaille les obliques en anti-rotation (pas en crunch latéral qui épaissit la taille)</li>
<li><strong>Farmer's walk unilatéral</strong> : 3 �- 30m/côté �?" obliques et stabilisation du tronc</li>
<li><strong>Ab wheel rollout</strong> : 3 �- 10-12 �?" grand droit et transverse</li>
<li><strong>Dead bug</strong> : 3 �- 10/côté �?" stabilisation profonde</li>
</ul>

<blockquote style="background:#f0fdf4;border-left:4px solid #22c55e;padding:16px 20px;margin:20px 0;border-radius:8px;">
�Y'� <strong>Avis d'expert :</strong> <em>"Arrêtez les crunchs obliques avec poids qui épaississent votre taille. Faites des exercices anti-latéroflexion et anti-rotation �?" Pallof press, farmer's walk unilatéral. Ils sculptent les obliques sans élargir."</em> �?" <strong>Jeff Nippard</strong>
</blockquote>
...
<blockquote style="background:#e8f4fd;border-left:4px solid #0ea5e9;padding:16px 20px;margin:20px 0;border-radius:8px;">
�Y"� <strong>Ce que dit la science :</strong> Schoenfeld et al. (2014, <em>Journal of the ISSN</em>) ont montré que le cardio à jeun ne brûle PAS plus de graisse totale que le cardio nourri sur 24h. Cependant, certains chercheurs comme Lyle McDonald argumentent que pour la graisse tenace spécifiquement (récepteurs alpha-2), l'état à jeun avec catécholamines élevées peut avoir un léger avantage de mobilisation �?" mais l'effet reste modeste.
</blockquote>

<div style="background:#f0f7ff;border-left:4px solid #2563eb;padding:20px;margin:30px 0;border-radius:8px;">
<h3 style="margin-top:0;">�YZ� Perdez les poignées d'amour durablement</h3>
<p>Le programme <strong>Sèche 10 Semaines</strong> est calibré pour vous amener dans la zone où les poignées d'amour commencent à fondre �?" avec une stratégie nutritionnelle et un entraînement qui ciblent la graisse abdominale tenace.</p>
<p><a href="https://seche10semaines.fr" style="color:#2563eb;font-weight:bold;">�?' Découvrir le programme Sèche 10 Semaines</a></p>
</div>
`
  },
...
<p>Ce guide coupe à travers le bruit. Voici ce que dit vraiment la science �?" et ce dont vous avez réellement besoin.</p>

<blockquote style="background:#e8f4fd;border-left:4px solid #0ea5e9;padding:16px 20px;margin:20px 0;border-radius:8px;">
�Y"� <strong>Ce que dit la science :</strong> Morton et al. (2018, <em>British Journal of Sports Medicine</em>, méta-analyse de 49 études, n=1 863) ont conclu que la supplémentation en protéines augmente significativement les gains de masse musculaire (+0,3 kg) et de force (+2,49 kg au 1RM) chez les personnes pratiquant la musculation. L'effet est plus marqué chez les sujets entraînés et en déficit calorique.
</blockquote>
...
<blockquote style="background:#f0fdf4;border-left:4px solid #22c55e;padding:16px 20px;margin:20px 0;border-radius:8px;">
�Y'� <strong>Avis d'expert :</strong> <em>"La whey n'est pas un complément magique. C'est de la nourriture sous forme de poudre. Si vous atteignez vos cibles protéiques avec des aliments entiers, vous n'en avez pas besoin. Mais en sèche, quand les calories sont limitées, c'est un outil extrêmement pratique."</em> �?" <strong>Alan Aragon</strong>
</blockquote>
...
<blockquote style="background:#e8f4fd;border-left:4px solid #0ea5e9;padding:16px 20px;margin:20px 0;border-radius:8px;">
�Y"� <strong>Ce que dit la science :</strong> Hulmi et al. (2015, <em>Journal of the ISSN</em>) n'ont trouvé aucune différence significative entre whey isolate et concentrate pour la composition corporelle ou la force chez des sujets entraînés sur 12 semaines. La différence est principalement dans la digestibilité (avantage isolate pour les intolérants au lactose) et le profil calorique légèrement meilleur.
</blockquote>
...
<li><strong>Pour un homme de 80 kg à 2,2 g/kg</strong> : 176 g de protéines/jour �?' ~90 g de whey max (le reste en viande, poisson, �"ufs, produits laitiers)</li>
</ul>

<blockquote style="background:#f0fdf4;border-left:4px solid #22c55e;padding:16px 20px;margin:20px 0;border-radius:8px;">
�Y'� <strong>Avis d'expert :</strong> <em>"La dose de 20-40 g de protéines par prise est le sweet spot pour maximiser la synthèse protéique musculaire. Au-delà, il y a un plateau de stimulation �?" les acides aminés supplémentaires sont oxydés comme carburant, pas utilisés pour construire du muscle."</em> �?" <strong>Stuart Phillips</strong>, Université McMaster
</blockquote>
...
<blockquote style="background:#e8f4fd;border-left:4px solid #0ea5e9;padding:16px 20px;margin:20px 0;border-radius:8px;">
�Y"� <strong>Ce que dit la science :</strong> Schoenfeld et al. (2013, <em>Journal of the ISSN</em>, méta-analyse) ont conclu que la "fenêtre anabolique" post-entraînement est beaucoup plus large que les "30 minutes" traditionnelles. Si vous avez mangé un repas protéiné dans les 3-4h précédant l'entraînement, le timing post-entraînement est moins critique. Visez un apport protéique dans les 2-3 heures suivant la séance.
</blockquote>
...
<ol>
<li><strong>Profil protéique</strong> : >80% de protéines (vérifiez l'étiquette : protéines/100g ÷ calories/100g �- 400 devrait être >80)</li>
...
<div style="background:#f0f7ff;border-left:4px solid #2563eb;padding:20px;margin:30px 0;border-radius:8px;">
<h3 style="margin-top:0;">�Y�� Protéines intégrées à vos menus</h3>
<p>Le programme <strong>Sèche 10 Semaines</strong> intègre la whey dans vos menus quotidiens quand c'est pertinent �?" avec les dosages, le timing et les recettes de shakes adaptés à votre phase de sèche.</p>
<p><a href="https://seche10semaines.fr" style="color:#2563eb;font-weight:bold;">�?' Découvrir le programme Sèche 10 Semaines</a></p>
</div>
`
  },
...
<blockquote style="background:#f0fdf4;border-left:4px solid #22c55e;padding:16px 20px;margin:20px 0;border-radius:8px;">
�Y'� <strong>Avis d'expert :</strong> <em>"L'environnement alimentaire prédit le comportement alimentaire bien mieux que la motivation. Si votre frigo est rempli de bons choix, vous ferez de bons choix. Le meal prep est un outil de design environnemental, pas juste de cuisine."</em> �?" <strong>Dr. Layne Norton</strong>
</blockquote>
...
<li>�?pices variées (cumin, paprika, curry, herbes de Provence, ail en poudre)</li>
</ul>

<h3>Le planning des 2 heures</h3>
<ol>
<li><strong>0-15 min</strong> : Lancez le riz/quinoa + préchauffez le four à 200°C</li>
<li><strong>15-45 min</strong> : Préparez et enfournez les protéines (poulet, saumon, b�"uf)</li>
...
<li><strong>105-120 min</strong> : �?tiquetez (jour + macros) et rangez au frigo/congélateur</li>
</ol>
...
<li>�?pices : cumin, paprika fumé, ail en poudre, sel</li>
...
<li>Ajoutez le b�"uf haché et faites-le brunir 5-7 min</li>
...
<h3>Recette 5 : Egg Muffins (petit-déjeuner �- 5 jours)</h3>
...
<p><strong>Préparation :</strong></p>
<ol>
<li>Battez les �"ufs, ajoutez légumes et épices</li>
...
<div style="background:#f0f7ff;border-left:4px solid #2563eb;padding:20px;margin:30px 0;border-radius:8px;">
<h3 style="margin-top:0;">�Y"< Menus et listes de courses automatiques</h3>
...
<p>Se lever à 6h, enfiler ses chaussures et courir le ventre vide pour "brûler directement dans les graisses". L'idée est séduisante. Mais est-elle scientifiquement fondée ? <strong>La réponse est nuancée �?" et probablement pas celle que vous attendez.</strong></p>
...
<blockquote style="background:#e8f4fd;border-left:4px solid #0ea5e9;padding:16px 20px;margin:20px 0;border-radius:8px;">
�Y"� <strong>Ce que dit la science :</strong> Aird et al. (2018, <em>Journal of Science and Medicine in Sport</em>, méta-analyse) ont conclu que le sport à jeun réduisait les performances d'exercice d'endurance de haute intensité, mais pas celles de basse intensité. La distinction est cruciale.
</blockquote>
...
<h3>�o. Cardio LISS à jeun : ACCEPTABLE</h3>
<ul>
...
<h3>�O HIIT ou musculation à jeun : D�?CONSEILL�?</h3>
<ul>
...
<blockquote style="background:#f0fdf4;border-left:4px solid #22c55e;padding:16px 20px;margin:20px 0;border-radius:8px;">
�Y'� <strong>Avis d'expert :</strong> <em>"Si vous aimez faire du cardio léger à jeun le matin, faites-le. Si vous détestez ça, ne le faites pas. La différence sur la perte de graisse est marginale �?" votre adhérence au déficit calorique total est 100�- plus importante."</em> �?" <strong>Eric Helms</strong>
</blockquote>
...
<li><strong>Petit-déjeuner protéiné dans l'heure</strong> : 30-40 g de protéines (�"ufs, whey + flocons d'avoine)</li>
<li><strong>Musculation plus tard dans la journée</strong> (toujours nourri, jamais à jeun)</li>
</ol>

<div style="background:#f0f7ff;border-left:4px solid #2563eb;padding:20px;margin:30px 0;border-radius:8px;">
<h3 style="margin-top:0;">�YO. Protocole cardio matinal intégré</h3>
...
<blockquote style="background:#f0fdf4;border-left:4px solid #22c55e;padding:16px 20px;margin:20px 0;border-radius:8px;">
�Y'� <strong>Avis d'expert :</strong> <em>"La rétention d'eau est la raison n°1 pour laquelle les gens pensent que leur sèche ne fonctionne pas. Vous PERDEZ de la graisse �?" mais l'eau la masque. Gardez le cap. Le whoosh viendra."</em> �?" <strong>Lyle McDonald</strong>
</blockquote>
...
<p>Le problème n'est pas le sel lui-même �?" c'est les <strong>fluctuations</strong>. Passer de 2 g un jour à 6 g le lendemain provoque une rétention massive.</p>
...
<blockquote style="background:#f0fdf4;border-left:4px solid #22c55e;padding:16px 20px;margin:20px 0;border-radius:8px;">
�Y'� <strong>Avis d'expert :</strong> <em>"Le refeed est l'outil anti-rétention le plus puissant. Un jour à +100-150 g de glucides au-dessus de la maintenance fait chuter le cortisol et déclenche souvent un whoosh dans les 48h. Placez-le la veille d'un jour de repos."</em> �?" <strong>Dr. Mike Israetel</strong>
</blockquote>
...
<blockquote style="background:#e8f4fd;border-left:4px solid #0ea5e9;padding:16px 20px;margin:20px 0;border-radius:8px;">
�Y"� <strong>Ce que dit la science :</strong> Nielsen et al. (2010, <em>Magnesium Research</em>) ont montré qu'une supplémentation en magnésium réduisait les marqueurs d'inflammation et la rétention d'eau chez les sujets déficients. ~48% des adultes ne consomment pas assez de magnésium.
</blockquote>
...
<p>L'activité physique légère active la pompe musculaire des mollets, qui renvoie le liquide interstitiel dans la circulation. 30 min de marche/jour réduisent significativement l'�"dème des membres inférieurs.</p>
...
<div style="background:#fff3cd;border-left:4px solid #ffc107;padding:20px;margin:20px 0;border-radius:8px;">
<strong>�s�️ �? éviter :</strong> les diurétiques pharmaceutiques (furosémide, etc.) sauf prescription médicale. Ils sont dangereux, peuvent causer des déséquilibres électrolytiques graves, et la rétention revient en force à l'arrêt.
</div>

<div style="background:#f0f7ff;border-left:4px solid #2563eb;padding:20px;margin:30px 0;border-radius:8px;">
<h3 style="margin-top:0;">�Y'� Gestion de l'eau intégrée</h3>
...
<p>Pas de salle de sport ? Pas d'excuses. Un programme au poids de corps bien conçu peut <strong>maintenir votre masse musculaire en sèche</strong> �?" à condition de respecter les principes de surcharge progressive et d'intensité suffisante.</p>

<blockquote style="background:#e8f4fd;border-left:4px solid #0ea5e9;padding:16px 20px;margin:20px 0;border-radius:8px;">
�Y"� <strong>Ce que dit la science :</strong> Kikuchi & Nakazato (2017, <em>Journal of Exercise Science & Fitness</em>) ont montré que les pompes et le développé couché avec charge similaire produisent une activation musculaire comparable du grand pectoral et des triceps. La clé : l'intensité relative (effort proche de l'échec) est plus importante que la charge absolue pour la préservation musculaire.
</blockquote>

<blockquote style="background:#f0fdf4;border-left:4px solid #22c55e;padding:16px 20px;margin:20px 0;border-radius:8px;">
�Y'� <strong>Avis d'expert :</strong> <em>"Le poids de corps fonctionne pour la préservation musculaire en sèche si vous travaillez près de l'échec musculaire. Le problème n'est pas le manque de poids �?" c'est le manque d'intensité. Si vous faites 50 pompes facilement, il faut progresser vers des variantes plus difficiles."</em> �?" <strong>Brad Schoenfeld</strong>
</blockquote>
...
<ul>
<li><strong>Variantes plus difficiles</strong> : pompes �?' pompes déclinées �?' pompes archer �?' pompes à 1 bras</li>
...
<table>
<tr><th>Exercice</th><th>Séries �- Reps</th><th>Repos</th><th>Tempo</th></tr>
<tr><td>Pompes déclinées (pieds surélevés)</td><td>4 �- 8-12</td><td>90 sec</td><td>3-1-2-0</td></tr>
<tr><td>Pompes diamant</td><td>3 �- 8-12</td><td>90 sec</td><td>3-1-2-0</td></tr>
<tr><td>Pike push-ups (épaules)</td><td>3 �- 8-10</td><td>90 sec</td><td>2-1-2-0</td></tr>
<tr><td>Dips entre deux chaises</td><td>3 �- 10-15</td><td>60 sec</td><td>3-0-2-0</td></tr>
<tr><td>Pompes archer (avancé)</td><td>3 �- 5-8/côté</td><td>90 sec</td><td>3-1-2-0</td></tr>
</table>
...
<table>
<tr><th>Exercice</th><th>Séries �- Reps</th><th>Repos</th><th>Notes</th></tr>
<tr><td>Tractions (barre de porte)</td><td>4 �- max</td><td>2 min</td><td>Si pas de barre : rowing inversé sous une table</td></tr>
<tr><td>Rowing inversé (table solide)</td><td>3 �- 10-12</td><td>90 sec</td><td>Pieds surélevés pour plus de difficulté</td></tr>
<tr><td>Superman hold</td><td>3 �- 20 sec</td><td>60 sec</td><td>Serrez les fessiers et le haut du dos</td></tr>
<tr><td>Ab wheel ou mountain climbers lents</td><td>3 �- 12</td><td>60 sec</td><td>Contrôle total du bassin</td></tr>
<tr><td>Dead bug</td><td>3 �- 10/côté</td><td>60 sec</td><td>Anti-extension du dos</td></tr>
</table>
...
<table>
<tr><th>Exercice</th><th>Séries �- Reps</th><th>Repos</th><th>Notes</th></tr>
<tr><td>Bulgarian split squat</td><td>4 �- 10-12/jambe</td><td>90 sec</td><td>Pied arrière sur chaise ou canapé</td></tr>
<tr><td>Squat pistol (ou assisté)</td><td>3 �- 5-8/jambe</td><td>2 min</td><td>Tenez un meuble pour l'équilibre au début</td></tr>
<tr><td>Pont fessier unilatéral</td><td>3 �- 12-15/jambe</td><td>60 sec</td><td>Pause 2 sec en haut</td></tr>
<tr><td>Nordic curl négatif</td><td>3 �- 5-8</td><td>90 sec</td><td>Pieds coincés sous un meuble, descendez lentement</td></tr>
<tr><td>Mollets unilatéral sur marche</td><td>4 �- 15-20</td><td>45 sec</td><td>Amplitude complète</td></tr>
</table>
